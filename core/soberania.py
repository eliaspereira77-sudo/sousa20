...
class ContratoSoberania:
    ...
    def conceder_autorizacao(
        ...
        *,
        ...
        """
        Registra autorização concedida pelo núcleo/operador soberano.

        Com autorizada=True (via token ou flag), validar_operacao permite a ação.
        """
    ...
    def consumir_autorizacao(
        ...
        *,
        ...
        """
        Verifica se existe autorização válida para a ação.
        Se auth_id for informado, usa essa; senão busca a mais recente compatível.
        """
    ...
    def validar_operacao(
        ...
        *,
        ...
        # Tenta consumir autorização explícita se ainda não marcada como autorizada
        if not autorizada:
